...
export default class Recommend extends Component {
    ...
    render() {
        ...
        //第一张
        let _img1 = recommends[0].gThumBPic || require('../../images/empty.png');
        gid1 = recommends[0].gID || 0;
        p1 = <Image source={{uri: _img1}} style={styles.bigImg} />;
        //第二张
        if(!recommends[1]) recommends[1] = recommends[0];
        let _img2 = recommends[1].gThumBPic || require('../../images/empty.png');
        gid2 = recommends[1].gID || 0;
        p2 = <Image source={{uri: _img2}} style={styles.smallImg} />;
        //第三张
        if(!recommends[2]) recommends[2] = recommends[1];
        let _img3 = recommends[2].gThumBPic || require('../../images/empty.png');
        gid3 = recommends[2].gID || 0;
        p3 = <Image source={{uri: _img3}} style={styles.smallImg} />;
